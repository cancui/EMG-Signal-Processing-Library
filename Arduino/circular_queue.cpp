...
CircularQueue::CircularQueue() : head_(0), tail_(0), capacity_(16), size_(0)
{
	items_ = new int[16];
}

CircularQueue::CircularQueue(unsigned int capacity) : head_(0), tail_(0), capacity_(capacity), size_(0)
{
